...
class Hades2Context(CommonContext):
    ...
    async def start_bridge_server(self) -> None:
        # Bind in a retry loop so a stuck port (a previous Hades 2 Client still holding
        ...
        while not self.exit_event.is_set():
            try:
                ...
                logger.warning(
                    ...
                    "another Hades 2 Client may still be running. Retrying in 5s "
    ...
    def evaluate_goal(self, payload: str) -> None:
        ...
        parts = payload.split("-")
        try:
            chronos_clears, chronos_weapons, typhon_clears, typhon_weapons = (int(p) for p in parts[:4])
        ...
        if goal == 1:
            ...
            done = chronos_ok or typhon_ok
        elif goal == 3:
            done = chronos_ok and typhon_ok
        else:
            done = chronos_ok
    ...
    def run_gui(self) -> None:
        ...
        class Hades2Manager(GameManager):
            base_title = "Archipelago Hades 2 Client"
