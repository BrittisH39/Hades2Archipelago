...
item_table_extras: Dict[str, ItemData] = {
    ...
    # vanilla strength. Not progression -- it doesn't gate any location's reachability,
    # only the fight's runtime difficulty.
    "Progressive Zagreus Weaken": ItemData(hades2_base_item_id + 218, False, useful=True),
}
