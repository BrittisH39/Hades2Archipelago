...
-- intro run -- so the starting weapon and the surface-only redirect read from the last session's
-- cached settings here instead. Safe no-op if there's no cache yet (first ever connect).
